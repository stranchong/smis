...
<script type="text/javascript" src="js/course/update.js"></script>
</head>
<body id="loginBody">
			...
			<table cellpadding="0" cellspacing="0" width="100%" height="95%" border="0">
				...
				<tr>
					...
					<td align="left" width="65%">
						<input id="cid" class="inputUP" value="${course.cid }" disabled="disabled" />
					</td>
				</tr>
				<tr>
					<td align="right" width="35%">课程名称：</td>
					<td align="left" width="65%">
						<input id="cname" class="inputUP" value="${course.cname }" />
					</td>
				</tr>
				<tr>
					<td align="right" width="35%">总学分：</td>
					<td align="left" width="65%">
						<input id="credit" class="inputUP" value="${course.credit }" />
					</td>
				</tr>
				<tr>
					<td align="right" width="35%">总学时：</td>
					<td align="left" width="65%">
						<input id="creditHours" class="inputUP" value="${course.creditHours }" />
					</td>
				</tr>
				<tr>
